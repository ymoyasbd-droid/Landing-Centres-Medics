export const translations = {
  es: {
    ...
    calc_tag: "Calculadora de ROI",
    calc_title: "¿Cuánto estás perdiendo cada mes?",
    calc_desc: "Las llamadas no atendidas y las citas que no se presentan (no-shows) son una fuga constante de ingresos. Descubre cuánto podrías recuperar con Sintel IA.",
    calc_citas: "Citas mensuales (aprox)",
    calc_precio: "Precio medio por certificado (€)",
    calc_perdida: "% de No-shows o llamadas perdidas",
    calc_result_text: "Pérdida estimada mensual:",
    calc_btn: "Recuperar estos ingresos",
  ...
  ca: {
    ...
    calc_tag: "Calculadora de ROI",
    calc_title: "Quant estàs perdent cada mes?",
    calc_desc: "Les trucades no ateses i les cites que no es presenten (no-shows) són una fuita constant d'ingressos. Descobreix quant podries recuperar amb Sintel IA.",
    calc_citas: "Cites mensuals (aprox)",
    calc_precio: "Preu mitjà per certificat (€)",
    calc_perdida: "% de No-shows o trucades perdudes",
    calc_result_text: "Pèrdua estimada mensual:",
    calc_btn: "Recuperar aquests ingressos",
