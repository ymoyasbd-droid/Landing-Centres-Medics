...
function App() {
  ...
  useEffect(() => {
    ...
    script.text = JSON.stringify({
      ...
      "image": "https://sintelai.es/hero.jpg",
  ...
  return (
    <div className="min-h-screen bg-dark text-white selection:bg-primary/30">
          ...
          <form className="space-y-6 max-w-2xl mx-auto" onSubmit={handleFormSubmit}>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-2 text-left">
                ...
                <input type="text" id="name" name="name" className="w-full bg-dark border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-primary transition-colors" placeholder="Ej. Dra. Laura Gómez" required />
              </div>
              <div className="space-y-2 text-left">
                <label htmlFor="email" className="text-sm font-medium text-muted">Correo electrónico</label>
      ...
      {/* Footer */}
      <footer className="border-t border-white/5 py-12 text-center bg-dark">
        <div className="container mx-auto px-6">
          ...
          <div className="text-muted text-sm flex flex-col md:flex-row justify-center items-center gap-4">
            ...
            <a href="mailto:ymoyasbd@gmail.com" className="hover:text-white transition-colors">comercial@sintelai.es</a>
            <span className="hidden md:inline">•</span>
            <a href="https://wa.me/34614056307" target="_blank" rel="noreferrer" className="hover:text-white transition-colors flex items-center gap-1">
               <PhoneOff size={14} className="hidden" />
               +34 614 056 307
            </a>
            <span className="hidden md:inline">•</span>
